  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center">
      <div className="text-center">
        ...
        <p className="text-muted mb-4">Enter a username — we'll fetch repos, stars, and languages.</p>
        ...
        {error && <div className="alert alert-danger mt-3 mx-auto" style={{ maxWidth: 400 }}>{error}</div>}
      </div>
    </div>
  );
}
