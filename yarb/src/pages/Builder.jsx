      ...
      <div className="container py-4">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p style={{ color: mutedColor }} className="small mb-0">
              Edits sync instantly to your live preview.
            </p>
          </div>
          <button
        ...
        <div className="row g-3">
            ...
            >
              {sections.map((s) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      active === s.id ? "#7c3aed" : "transparent",
                    color: active === s.id ? "white" : mutedColor,
                    borderRadius: 10,
                  }}
                >
          ...
          <div className="col">
            ...
            >
              {active === "template" && (
                <div>
                  <p style={{ color: mutedColor }} className="small mb-3">
                    Pick a template — changes apply instantly to your live
                    preview.
                  </p>
                  <div className="row g-3">
                    {templates.map((t) => (
                      <div className="col-12 col-md-4" key={t.id}>
                        <div
                          ...
                          style={{
                            borderRadius: 12,
                            border: `2px solid ${portfolio.template === t.id ? "#7c3aed" : borderColor}`,
                            overflow: "hidden",
                            cursor: "pointer",
                          }}
                        >
                          ...
                          >
                            ...
                            {t.id === "dark" && (
                              ...
                              >
                                ...
                                <div>$ ls --skills</div>
                                <div>
                                  {portfolio.skills.slice(0, 3).join(" · ") ||
                                    "your skills"}
                                </div>
                              </div>
                            )}
              ...
              {active === "theme" && (
                <div>
                  <div className="mb-2 small" style={{ color: mutedColor }}>
                    Accent color
                  </div>
                    ...
                    {accents.map((a) => (
                      <button
                        ...
                        style={{
                          ...
                          border: `2px solid ${portfolio.accent === a.id ? "white" : "transparent"}`,
                          cursor: "pointer",
                        }}
                      />
                    ))}
